...
namespace E_State.DataAccess.Migrations
{
    ...
    [Migration("20240116100438_mig_adduserstatus")]
    partial class mig_adduserstatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Advert", b =>
                {
            ...
            modelBuilder.Entity("E_State.Entities.Entities.City", b =>
                {
                    b.Property<int>("CityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_State.Entities.Entities.District", b =>
                {
                    b.Property<int>("DistrictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_State.Entities.Entities.GeneralSettings", b =>
                {
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Images", b =>
                {
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Neighbourhood", b =>
                {
                    b.Property<int>("NeighbourhoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NeighbourhoodKey")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Situation", b =>
                {
                    b.Property<int>("SituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Type", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_State.Entities.Entities.UserAdmin", b =>
                {
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Advert", b =>
                {
                    b.HasOne("E_State.Entities.Entities.Neighbourhood", "Neighbourhood")
                        .WithMany()
                        .HasForeignKey("NeighbourhoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_State.Entities.Entities.Type", "Type")
                        .WithMany("Adverts")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_State.Entities.Entities.UserAdmin", "UserAdmin")
                        .WithMany("Adverts")
            ...
            modelBuilder.Entity("E_State.Entities.Entities.District", b =>
                {
                    b.HasOne("E_State.Entities.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Images", b =>
                {
                    b.HasOne("E_State.Entities.Entities.Advert", "Advert")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Neighbourhood", b =>
                {
                    b.HasOne("E_State.Entities.Entities.District", "District")
            ...
            modelBuilder.Entity("E_State.Entities.Entities.Type", b =>
                {
                    b.HasOne("E_State.Entities.Entities.Situation", "Situation")
                        .WithMany("Types")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_State.Entities.Entities.UserAdmin", null)
                        .WithMany()
